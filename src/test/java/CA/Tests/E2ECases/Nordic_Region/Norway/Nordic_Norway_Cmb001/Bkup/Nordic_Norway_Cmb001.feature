...
Scenario Outline: <TestCaseID>------Sample POC for Dplay CA Modularized 
    ...
    * def result = call read('classpath:CA/Features/ReUsable/Dynamodb.feature@ValidateWochitPayload') {Param_TableName: 'CA_WOCHIT_RENDITIONS_EU-qa',Param_ScanAttr:'aspectRatio',Param_ScanVal:'ASPECT_16_9',Param_Expected_VideoUpdates:'#(Expected_VideoUpdates)',Param_Expected_Item_AspectRatio_TemplateID: '#(ExpectedItem_AspectRatio_TemplateID)',Param_Expected_TimelineItems:'#(Expected_TimelineItems)',Param_Expected_Status:'#(Expected_Status)'}
    ...
    * def Expected_Item_AspectRatio_TemplateID = read('classpath:CA/Tests/E2ECases/Nordic_Region/Norway/' + <TestCaseID> +'/Output/Expected4_5_Item_AspectRatio_TemplateID.txt')
    ...
    * print '-----------------Validate Paload to Wochit , File Name , Rendition Status for 1x1----------------'
    * def Expected_VideoUpdates = read('classpath:CA/Tests/E2ECases/Nordic_Region/Norway/' + <TestCaseID> +'/Output/Expected_VideoUpdates_1_1.txt')
    * replace Expected_VideoUpdates.TTBR = RandomSeriesTitle
    * replace Expected_VideoUpdates.CallOutText = RandomCalloutText
    * replace Expected_VideoUpdates.CTA = RandomCTA
    * replace Expected_VideoUpdates.AR = '1x1'
    * def Expected_Item_AspectRatio_TemplateID = read('classpath:CA/Tests/E2ECases/Nordic_Region/Norway/' + <TestCaseID> +'/Output/Expected1_1_Item_AspectRatio_TemplateID.txt')
    * def result = call read('classpath:CA/Features/ReUsable/Dynamodb.feature@ValidateWochitPayload') {Param_TableName: 'CA_WOCHIT_RENDITIONS_EU-qa',Param_ScanAttr:'aspectRatio',Param_ScanVal:'ASPECT_1_1',Param_Expected_VideoUpdates:'#(Expected_VideoUpdates)',Param_Expected_Item_AspectRatio_TemplateID: '#(Expected_Item_AspectRatio_TemplateID)',Param_Expected_TimelineItems:'#(Expected_TimelineItems)',Param_Expected_Status:'#(Expected_Status)'}
