...
Scenario: Background
    ...
    * def GetAppTokenInfoParams =
        ...
        """
    * def IconikAuthenticationInfo = call read(FeatureFilePath + '/Iconik.feature@GetAppTokenInfo') GetAppTokenInfoParams
    ...
    * def getIconikACL =
        ...
        """
    * def ExpectedIconikACLUserGroupId = call getIconikACL GetIconikACLParams
    # Iconik Stuff End
    ...
    * def updateFinalResultParams = 
        ...
        """
    * call read(FeatureFilePath + '/Results.feature@setPlaceholder') { customReportplaceholderParams: #(customReportplaceholderParams) })
    ...
    * def Pause = 
        ...
        """
    * call Pause WaitTime
    * def one = call read(FeatureFilePath + '/RandomGenerator.feature@SeriesTitle')
    * def RandomSeriesTitle = one.RandomSeriesTitle
    * def two = call read(FeatureFilePath + '/RandomGenerator.feature@CallOutText')
    * def RandomCalloutText = two.RandomCalloutText
    * def three = call read(FeatureFilePath + '/RandomGenerator.feature@CTA')
