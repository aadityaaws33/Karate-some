...
Background:
  ...
  * callonce read('classpath:CA/Features/ReUsable/Scenarios/Background.feature') { WaitTime: 2000 }
...
Scenario Outline: Nordic_Norway_Dplus_Essential_Panel_All_NoStrap_CTAMutliLine - PROCESSING - Validate Wochit Mapping table entry for Aspect Ratio: <ASPECTRATIO> [wochitRenditionStatus: <RENDITIONSTATUS> - isRenditionMoved: <ISRENDITIONMOVED>]
...
Scenario Outline: Nordic_Norway_Dplus_Essential_Panel_All_NoStrap_CTAMutliLine - FINISHED - Validate Wochit Mapping table entry for Aspect Ratio: <ASPECTRATIO> [wochitRenditionStatus: <RENDITIONSTATUS> - isRenditionMoved: <ISRENDITIONMOVED>]
  # RUN ONLY IN E2E, DO NOT RUN IN REGRESSION
  * configure abortedStepsShouldPass = true
  * eval if (!TargetTag.contains('E2E')) {karate.abort();}
  # ---------
...
Scenario Outline: Nordic_Norway_Dplus_Essential_Panel_All_NoStrap_CTAMutliLine - Validate if <ASPECTRATIO> S3 Asset exists
  # RUN ONLY IN E2E, DO NOT RUN IN REGRESSION
  * configure abortedStepsShouldPass = true
  * eval if (!TargetTag.contains('E2E')) {karate.abort();}
  # ---------
...
Scenario Outline: Nordic_Norway_Dplus_Essential_Panel_All_NoStrap_CTAMutliLine - Validate Associated Assets and their ACLs for <ASPECTRATIO> exist
  # RUN ONLY IN E2E, DO NOT RUN IN REGRESSION
  * configure abortedStepsShouldPass = true
  * eval if (!TargetTag.contains('E2E')) {karate.abort();}
  # ---------
