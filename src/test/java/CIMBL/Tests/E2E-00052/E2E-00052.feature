Feature:  E2E-00052: Querying getFixtures with a filter where date.eq is an invalid date

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00052: Querying getFixtures with a filter where date.eq is an invalid date
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00052/E2E-00052.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00052/'
