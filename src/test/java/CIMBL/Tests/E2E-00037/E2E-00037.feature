Feature:  E2E-00037: Querying getFixtures with a combination of filters where team.id.eq is null and league.id.eq is valid

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00037: Querying getFixtures with a combination of filters where team.id.eq is null and league.id.eq is valid
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00037/E2E-00037.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00037/'
