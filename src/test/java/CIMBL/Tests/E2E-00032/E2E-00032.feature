Feature:  E2E-00032: Querying getFixtures with a filter where league.id.eq is {}

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00032: Querying getFixtures with a filter where league.id.eq is {}
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00032/E2E-00032.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00032/'
