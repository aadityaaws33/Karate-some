Feature:  E2E-00031: Querying getFixtures with a filter where league.id.eq is a null string

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00031: Querying getFixtures with a filter where league.id.eq is a null string
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00031/E2E-00031.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00031/'
