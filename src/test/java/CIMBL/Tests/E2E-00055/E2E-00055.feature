Feature:  E2E-00055: Querying getFixtures with a filter where date.eq is null

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00055: Querying getFixtures with a filter where date.eq is null
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00055/E2E-00055.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00055/'
