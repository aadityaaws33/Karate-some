Feature:  E2E-00070: Querying getFixtures with round field should return correct data
          SKIP FOR PROD and PRODGREEN ENV. FEATURE NOT YET PUSHED TO PROD

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00070: Querying getFixtures with round field should return correct data
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00070/E2E-00070.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00070/'
...
Scenario: E2E-00070: Querying getFixtures with round field should return correct data
  ...
  * eval if (targetEnv == 'prodGreen') {karate.abort()}
