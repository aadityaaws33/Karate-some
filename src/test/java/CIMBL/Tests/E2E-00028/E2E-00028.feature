Feature:  E2E-00028: Querying getFixtures with a filter where team is {}

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00028: Querying getFixtures with a filter where team is {}
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00028/E2E-00028.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00028/'
