Feature:  E2E-00048: Querying getFixtures with a filter where status.eq is null

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00048: Querying getFixtures with a filter where status.eq is null
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00048/E2E-00048.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00048/'
