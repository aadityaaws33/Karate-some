Feature:  E2E-00022: Querying getFixtures with a filter where the team id is non-existing

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00022: Querying getFixtures with a filter where the team id is non-existing
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00022/E2E-00022.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00022/'
