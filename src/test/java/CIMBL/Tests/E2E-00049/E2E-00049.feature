Feature:  E2E-00049: Querying getFixtures with a filter where status is an empty object

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00049: Querying getFixtures with a filter where status is an empty object
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00049/E2E-00049.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00049/'
