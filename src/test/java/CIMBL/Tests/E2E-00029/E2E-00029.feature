Feature:  E2E-00029: Querying getFixtures with a filter where league.id.eq is a valid league Id

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00029: Querying getFixtures with a filter where league.id.eq is a valid league Id
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00029/E2E-00029.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00029/'
