Feature:  E2E-00040: Querying getTeams when league Id is null

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00040: Querying getTeams when league Id is null
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00040/E2E-00040.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00040/'
