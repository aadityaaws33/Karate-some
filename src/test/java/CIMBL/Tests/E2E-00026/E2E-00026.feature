Feature:  E2E-00026: Querying getFixtures with a filter where teams.id.eq is an empty object

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00026: Querying getFixtures with a filter where teams.id.eq is an empty object
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00026/E2E-00026.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00026/'
