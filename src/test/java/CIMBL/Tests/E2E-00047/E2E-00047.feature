Feature:  E2E-00047: Querying getFixtures with a filter where status.eq is an invalid status

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00047: Querying getFixtures with a filter where status.eq is an invalid status
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00047/E2E-00047.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00047/'
