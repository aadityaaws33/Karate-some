Feature:  E2E-00033: Querying getFixtures with a filter where league.id.eq is null

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00033: Querying getFixtures with a filter where league.id.eq is null
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00033/E2E-00033.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00033/'
