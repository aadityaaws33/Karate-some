Feature:  E2E-00043: Querying getLeagueStandings when leagueId is nul should return error

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00043: Querying getLeagueStandings when leagueId is nul should return error
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00043/E2E-00043.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00043/'
