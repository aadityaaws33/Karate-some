Feature:  E2E-00046: Querying getFixtures with a filter where status.eq is a valid status

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00046: Querying getFixtures with a filter where status.eq is a valid status
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00046/E2E-00046.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00046/'
