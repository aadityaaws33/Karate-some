Feature:  E2E-00030: Querying getFixtures with a filter where league.id is {}

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00030: Querying getFixtures with a filter where league.id is {}
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00030/E2E-00030.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00030/'
