Feature:  E2E-00044: Querying getLeagueStandings when leagueId is non-existent should return error

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00044: Querying getLeagueStandings when leagueId is non-existent should return error
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00044/E2E-00044.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00044/'
