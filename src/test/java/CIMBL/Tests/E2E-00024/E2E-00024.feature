Feature:  E2E-00024: Querying getFixtures with a filter where the team.id is {}

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00024: Querying getFixtures with a filter where the team.id is {}
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00024/E2E-00024.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00024/'
