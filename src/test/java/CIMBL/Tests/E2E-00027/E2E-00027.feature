Feature:  E2E-00027: Querying getFixtures with a filter where team.id.eq is null

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00027: Querying getFixtures with a filter where team.id.eq is null
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00027/E2E-00027.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00027/'
