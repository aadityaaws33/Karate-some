Feature:  E2E-00045: Querying getLeagueStandings when leagueId is an empty string should return error

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00045: Querying getLeagueStandings when leagueId is an empty string should return error
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00045/E2E-00045.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00045/'
