Feature:  E2E-00036: Querying getFixtures with a combination of filters where team.id.eq and league.id.eq are valid

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00036: Querying getFixtures with a combination of filters where team.id.eq and league.id.eq are valid
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00036/E2E-00036.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00036/'
