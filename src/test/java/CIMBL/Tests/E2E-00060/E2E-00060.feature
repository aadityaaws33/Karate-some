Feature:  E2E-00060: Querying getFixtures with a filter where date.eq is a valid date format (YYYY/MM/DD)

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00060: Querying getFixtures with a filter where date.eq is a valid date format (YYYY/MM/DD)
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00060/E2E-00060.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00060/'
