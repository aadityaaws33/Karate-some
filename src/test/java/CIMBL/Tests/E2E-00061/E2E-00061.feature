Feature:  E2E-00061: Querying getFixtures with a filter where date.eq is a valid date format (YYYY-MM-DDThh:mm:ss.xxxZ)

# [ TEST CODE ]
# @Regression
# Scenario: E2E-00061: Querying getFixtures with a filter where date.eq is a valid date format (YYYY-MM-DDThh:mm:ss.xxxZ)
#     When def result = karate.callSingle('classpath:CIMBL/Tests/E2E-00061/E2E-00061.feature')
#     Then match result.testStatus == 'pass'

Background:
  * url CIMBLbaseUrl
  * def currentPath = 'classpath:CIMBL/Tests/E2E-00061/'
